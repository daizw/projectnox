...
public class DHKeyAgreement3 {
    ...
    private void run() throws Exception {
        ...
        // How about comparing Alice and Carol?
        if (!java.util.Arrays.equals(aliceSharedSecret, carolSharedSecret))
            throw new Exception("Alice and Carol differ");
        System.out.println("Alice and Carol are the same");
    }
